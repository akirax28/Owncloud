...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = '© 2020 Nuvem IFRR'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'ownCloud'; /* short name, used when referring to the software */
		$this->defaultTitle = 'ownCloud'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://reitoria.ifrr.edu.br/dti';
		...
		$this->defaultSlogan = $this->l->t('Owncloud Personalizado pela DTI');
